...
export default function ProjectHero() {
    ...
    return (
        <div ref={scope} className="flex flex-col sm:pl-[75px] relative overflow-hidden justify-center py-[10%] transition-all text-center sm:text-left bg-black">
            {/* <motion.h1
            initial={{ opacity: 0 }}
            animate={{ opacity: 100 }}
            transition={{ duration: 1 }}
            className="font-semibold tracking-widest uppercase text-5xl sm:text-6xl">
                Projects
            </motion.h1>
            <motion.h1
            initial={{ opacity: 0 }}
            ...
            <motion.h1
            className="font-semibold tracking-widest uppercase text-5xl sm:text-6xl z-20">
                Projects
            </motion.h1>
            <motion.h1
            className="font-light tracking-widest uppercase z-20">
                
                view all my projects
            </motion.h1>
            <motion.h1 className='group/item text-md z-20 py-2'>
                <motion.a onClick={() => arrowLeave()} className='font-light' href="/">
                    Home&nbsp;
                    <motion.h1 className='group/item inline text-orange-500 group-hover/item:ml-2 group-hover/item:text-orange-300 transition-all duration-300 ease-out'>
                        <MotionArrow id='arrow' className='text-[16px] inline' />
            ...
            <Image className="absolute opacity-20 z-10" src={bgVideo} fill={true}/>
        </div>
    )
}
